...
public class ThemeActivity extends Fragment {
	...
	private TextView textViewTextSize, textViewRGB;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = getActivity().getLayoutInflater().inflate(
				R.layout.fragment_settings_tab_preference, null);
		
		activity = getActivity();
		
		textViewTextSize = (TextView) view.findViewById(R.id.size);
		textViewRGB = (TextView) view.findViewById(R.id.RGB);
		...
		seekBar.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
			public void onProgressChanged(SeekBar seekBar, int ps,
				...
				if (ps % 2 != 0)
					ps = ps + 1;
				progress = ps + 12;
				textViewTextSize.setText("Text size: " + (progress));
			}
...
//				SavePreferens("RGB", "color:rgb(172,173,131);");
				SavePreferens("RGB", "color:rgb(65, 158, 85);");
//				SavePreferens("R", 172 + "");
//				SavePreferens("G", 173 + "");
//				SavePreferens("B", 131 + "");
				SavePreferens("R", 65 + "");
...
//				seekBarB.setProgress(131);
				seekBarR.setProgress(65);
				seekBarG.setProgress(158);
				seekBarB.setProgress(85);
				seekBar.setProgress(6);
				SavePreferens("SeekBar", 6 + "");
//				textViewRGB.setBackgroundColor(Color.rgb(172, 173, 131));
				textViewRGB.setBackgroundColor(Color.rgb(65, 158, 85));
//				textViewRGB.setText("RGB(172,173,131)");
				textViewRGB.setText("RGB(65,158,85)");
			}
		});
		return view;
	}
	...
	SeekBar.OnSeekBarChangeListener SeekBarListener = new SeekBar.OnSeekBarChangeListener() {
		public void onProgressChanged(SeekBar seekBar, int progress,
			...
			textViewRGB.setBackgroundColor(Color.rgb(ColorR, ColorG, ColorB));
			textViewRGB.setText("RGB(" + ColorR + "," + ColorG + "," + ColorB + ")");
		}
