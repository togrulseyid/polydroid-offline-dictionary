...
import com.togrul.pd.views.TranslationInTextView;
import com.togrul.pd.views.TranslationInTextViewArabicCorrector;
...
public class PolyDroidActivity extends ActionBarActivity implements Observer,
	...
	public void WebViewTranslateOnTextView(CharSequence charSequence, long id) {
		...
		if(Build.VERSION.SDK_INT>Build.VERSION_CODES.HONEYCOMB) {
			 intent = new Intent(this, TranslationInTextView.class);
		}else {
			intent = new Intent(this, TranslationInTextViewArabicCorrector.class);
		}
		intent.putExtra("from", charSequence);
		Cursor c = databaseHelper.query(charSequence.toString(), spinnerText, id);
		c.moveToFirst();
		intent.putExtra("to",  c.getString(c.getColumnIndex("_to")));
